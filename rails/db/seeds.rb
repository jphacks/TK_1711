...
containers1 = user1.containers.create(name:"ソファ",date:"2017-10-20",duration:duration,status:status)
duration = rand(0..3)
status = rand(0..2)
user2 = User.create(name:"山田",address:"0x21ab4b628bd3af3bcfa38d18cf8de3d243026956",balance:3000)
for num in 1..5 do
    containers2 = user2.containers.create(name:"グラノーラ",date:"2017-10-20",duration:duration,status:status)
end
duration = rand(0..3)
status = rand(0..2)
user3 = User.create(name:"林",address:"0x786971589e24ca1d42ba813c0bd26936081b2085",balance:3502)
containers3 = user3.containers.create(name:"プロテイン",date:"2017-10-20",duration:duration,status:status)
duration = rand(0..3)
status = rand(0..2)
user4 = User.create(name:"さくま農家",address:"0x0b9d052652f94547464746a08e8281cd7aa6e059",balance:6000)
containers4 = user4.containers.create(name:"7up",date:"2017-10-20",duration:duration,status:status)
duration = rand(0..3)
status = rand(0..2)

user5 = User.create(name:"島根牧場",address:"0xc90b4266ac60846f20aade24978a57f60e4a81ba",balance:7000)
for num in 1..5 do
    containers5 = user5.containers.create(name:"カップ麺詰め替えセット", date:"2017-10-20",duration:duration,status:status)
end