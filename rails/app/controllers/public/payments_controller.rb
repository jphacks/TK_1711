class Public::PaymentsController < Public::BaseController
    ...
    def create
        ...
        @container = @user.containers.build(name:"卵",delivery_date:"2017-11-2", purchase_date:"2017-11-2", photo:"https://s3-ap-northeast-1.amazonaws.com/myblock/egg.jpg", duration:2,status:0)
